	    ...
	    return new Promise(function (resolve, reject) {
	        ...
	        _this4.requestViewModel(imageId).then(function () {
	            ...
	            if (!_this4.isElemSetted) _this4.setElem().then(function () {
	                ...
	                console.log(_this4.elem);
	                _this4.trigger('gallery_shown');
