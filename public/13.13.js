...
/***/ (function(module, exports, __webpack_require__) {
	...
	UploadImageModalWindow.prototype.setElem = function () {
	    ...
	    if (!this.elem) this.elem = this.renderWindow(__webpack_require__(65));
	...
	UploadImageModalWindow.prototype.uploadImage = function (file, description) {
	    ...
	    if (this.available) {
	        ...
	        __webpack_require__(59)("/image", formData, function (err, response) {
